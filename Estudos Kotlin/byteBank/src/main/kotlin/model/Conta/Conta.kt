...
/**
 * A classe model.Conta.Conta possui campos e métodos que representam uma
 * conta bancária.
...
class Conta(
     ...
     * faz a transferência desse valor do objeto atual para o objeto model.Conta.Conta
     * destino.
     * @param valor o valor a ser transferido
     * @param destino uma instância da classe model.Conta.Conta, que receberá o valor da
     * transferência
     * */
    ...
    override fun toString(): String {
        return "Nome Cliente: $nomeCliente\nNumero da model.Conta.Conta: $numeroConta\nSaldo: R$ $saldo\n"
    }
}